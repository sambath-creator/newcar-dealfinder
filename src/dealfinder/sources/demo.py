...
class DemoSource(ListingSource):
    ...
    def collect(self):
        return [
            ...
            VehicleListing(
                source=self.name,
                source_id="demo-ix1-001",
                url="https://example.com/ix1",
                title="2026 BMW iX1 xDrive30 M Sport",
                price_gbp=40500,
                mileage=12,
                registration_year=2026,
                latitude=51.50,
                longitude=0.12,
                dealer="Demo BMW Dealer",
                location="London",
                seats=5,
                propulsion="BEV",
                make="BMW",
                model="iX1",
                trim="xDrive30 M Sport",
                market_price_gbp=44000,
                specification_score=92,
                dealer_score=95,
                image_url="https://images.unsplash.com/photo-1556189250-72ba954cfc2b?q=80&w=600&auto=format&fit=crop",
            ),
        ]
